...
namespace RpgApi.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            (
                new Arma() { Id = 1, Nome = "A Cimitar dos Orcs", Dano = 10, PersonagemId = 7},
                new Arma() { Id = 2, Nome = "Espada de Gandalf", Dano = 27, PersonagemId = 1},
                new Arma() { Id = 3, Nome = "Espada de Aragorn", Dano = 25, PersonagemId = 3},
                new Arma() { Id = 4, Nome = "Cajado do Gandalf", Dano = 30, PersonagemId = 4},
                new Arma() { Id = 5, Nome = "Adaga", Dano = 15, PersonagemId = 5},
                new Arma() { Id = 6, Nome = "Olho de Sauron", Dano = 666, PersonagemId = 6},
                new Arma() { Id = 7, Nome = "Arco e Flecha elfico", Dano = 20, PersonagemId = 2}
            );
            ...
            ( 
                new Habilidade(){Id=1, Nome="Queimar", Dano=40}, 
                new Habilidade(){Id=2, Nome="Sangramento", Dano=35}, 
                new Habilidade(){Id=3, Nome="Envenenemento", Dano=30} 
            ); 
            ...
            ( 
                ...
                new PersonagemHabilidade() { PersonagemId = 6, HabilidadeId =3}, 
                new PersonagemHabilidade() { PersonagemId = 7, HabilidadeId =2} 
            );
